  ...
  return (
    <footer className="mt-16 border-t border-slate-200 bg-gradient-to-b from-white to-slate-50">
      <div className="w-full px-4 py-8 sm:px-6 lg:px-10">
        <div className="grid gap-7 text-sm text-slate-600 md:grid-cols-[1.2fr,1fr,1fr]">
          <div className="space-y-2">
            <p className="text-lg font-black text-slate-800">HamroBichar</p>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-start gap-3">
              ...
              >
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-500 via-pink-500 to-orange-400 text-white">
